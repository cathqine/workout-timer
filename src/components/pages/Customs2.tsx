  ...
  return (
    <>
      ...
      <div className="flex-row center-contents default-div" style={{ marginBottom: "2em" }}>
        <Blocks location="/workout-start-0" margin="0em auto 0em auto" value="4" text="Short" description={shortDesc} />
        <Blocks location="/workout-start-0" margin="0em auto 0em auto" value="8" text="Medium" description={medDesc} />
      </div>
      {/* HARDCODED !!!!!!! */}
      <div className="flex-row center-contents default-div" style={{ marginBottom: "2em" }}>
        <Blocks location="/workout-start-0" margin="0em auto 0em auto" value="12" text="Long" description={longDesc} />
        <Blocks location="/workout-start-0" margin="0em auto 0em auto" value="custom" text="Custom" description="? second per set" />
      </div>
    </>
  );
}
